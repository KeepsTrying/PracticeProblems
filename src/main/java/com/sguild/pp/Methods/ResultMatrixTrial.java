 ...
 */
package com.sguild.PracticeProgramming.Methods;
 ...
 * @author apprentice
 */
public class ResultMatrixTrial {
    ...
    public static void main(String[] args) {
        ...
        if (wantPlay.equalsIgnoreCase("Yes")) {
            ...
            do {
                ...
                //converting that choice to a string so we can display to the user
                // opponents action
                if (comp == 0){
                        compString = "Paper";
                }else if (comp == 1){
                ...
                //to ensure proper code function and validation
        ...
        /*
                ...
                //converting string to Interval for Assessment
                //implementing validation because "3" was accepted?
                if (userString.equalsIgnoreCase("Paper")) {
                    user = 0;
                } else if (userString.equalsIgnoreCase("Rock")) {
                    user = 1;
